...
//  K760FnKey
//
//  Created by NuRi on 12/10/13.
//  Copyright (c) 2013 NuRi. All rights reserved.
//
...
- (void)applicationDidFinishLaunching:(NSNotification *)aNotification
{
    ...
    if (CFGetTypeID(hidManager) != IOHIDManagerGetTypeID()) {
        NSLog(@"K760FnKey: fail to create IOHIDManager");
        return;
    }
...
//#define HID_PRODUCT_ID_K760                      (__s16)0xB316
    long HID_VENDOR_ID_LOGITECH = 0x046D;
    long HID_PRODUCT_ID_K760 = 0xB316;
    ...
    CFDictionarySetValue(matchDict,
                         ...
                         CFNumberCreate( kCFAllocatorDefault, kCFNumberSInt32Type, &HID_PRODUCT_ID_K760 ));
