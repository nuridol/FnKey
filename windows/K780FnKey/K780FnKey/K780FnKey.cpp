// K780FnKey.cpp : main project file.
#include "stdafx.h"
#include <windows.h>
#include <stdio.h>
#include <setupapi.h>
...
int Transfer(HANDLE hDevice)
{
	int sts = -1;
	DWORD len;
	// on = function(not media) without fn key
	...
	// K780
	//const char k780_seq_fkeys_on[] = {0x10, 0x02, 0x0c, 0x1a, 0x00, 0x00, 0x00};
	//const char k780_seq_fkeys_off[] = {0x10, 0x02, 0x0c, 0x1a, 0x01, 0x00, 0x00};

	BYTE buf[] = { 0x10, 0x02, 0x0c, 0x1a, 0x00, 0x00, 0x00 };
...
DWORD searchDevice()
{
	...
	// logitech K380
	// char *szIdStr1 = "vid_046d&pid_b342";
	// for windows 8.1
	// char *szIdStr2 = "046d_pid&b342";

	// logitech K780
	char *szIdStr1 = "vid_046d&pid_c52b";
	// for windows 8.1
	char *szIdStr2 = "046d_pid&c52b";
...
{
	Console::WriteLine(L"****************");
	Console::WriteLine(L" K780FnKey V1.0");
	Console::WriteLine(L"****************");
	Console::WriteLine(L"");
